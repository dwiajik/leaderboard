...
var pilihcalon = {
	...
	calonClickListener: function() {
		$('.calon-link').click(function() {
			var calonLinkNo = $(this).attr("data-target");
			var pageCalonAll = $('body').find('.page-calon-all');
			var pageCalonNo = '#calon-'+calonLinkNo;
			var pageCalon = $('body').find(pageCalonNo);

			pageCalonAll.hide();
			pageCalon.show();
			pageCalon.removeClass('hide');
		});
	},

	backClickListener: function() {
		$('calon-back').click(function() {
			$('.page-calon').hide();
			$('pageCalonAll').show();
		})
	},
	...
	showChart: function () {
		...
		$('#chart').highcharts({
			...
			series: self.candidates
		});
	},

	init: function() {
        this.initializeAll();
    	this.calonClickListener();
		this.showChart();
	}
};
